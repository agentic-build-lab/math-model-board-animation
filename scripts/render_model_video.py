...
def main() -> None:
    ...
    parser.add_argument("--require-video", action="store_true", help="Exit non-zero if mp4 encoding fails.")
    ...
    if args.require_video and encode_status != "success":
        raise SystemExit(f"mp4 encoding required but failed: {encode_error}")
